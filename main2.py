...
kinetic = {'ka': 1774.5565377706337,
           'ki(1)': 2469.7778815702673,
           'ki(2)': 243769.92107622142,
           'ki(3)': 11045.843291193129,
           'kp(1)': 10473.053854548818,
           'kp(2)': 441.6216957361743,
           'kp(3)': 82.1190548594279,
           'ktm(1)': 1.1032547812299299e-07,
           'ktm(2)': -6.649142367178875e-09,
           'ktm(3)': -6.671186957821945e-09,
           'kd(1)': 487.8026449474986,
           'kd(2)': 241.23492154332934,
           'kd(3)': 45.83948012224683}
...
reaction_set_1.source_define(6, [11, 28], {'name': 'Kd(2)', 'value': kinetic['kd(2)']}, [1, 1], [1, 1], False)
# Y0[3] + conuter-ion ——> D0[3] + ion-pair
reaction_set_1.source_define(6, [12, 28], {'name': 'Kd(3)', 'value': kinetic['kd(3)']}, [1, 1], [1, 1], False)
...
reaction_set_1.source_define(8, [8, 28], {'name': 'Kd(2)', 'value': kinetic['kd(2)']}, [1, 1], [1, 1], True)
# p1_ion[3] + counter_ion ——> D1[3] + ion-pair
reaction_set_1.source_define(9, [9, 28], {'name': 'Kd(3)', 'value': kinetic['kd(3)']}, [1, 1], [1, 1], True)
...
reaction_set_1.source_define(11, [11, 28], {'name': 'Kd(2)', 'value': kinetic['kd(2)']}, [1, 1], [1, 1], True)
# Y0[3] + counter-ion ——> D0[3] + ion-pair
reaction_set_1.source_define(12, [12, 28], {'name': 'Kd(3)', 'value': kinetic['kd(3)']}, [1, 1], [1, 1], True)
...
flow_toR130.set_MassFlow_conventional(
    {'IB': 4070., 'IP': 0, 'HCL': 0.238, 'EADC': 3.8, 'HEXANE': 6.3, 'CH3CL': 8600})
...
global_model.reactor_1.outflow = pyo.Var(component_index, initialize=init_values,
                                         domain=pyo.NonNegativeReals)
...
reactor1_model = CstrSingleLiqPhase(198, 101325, 5.1, flow_to_reactor1, reaction_set_1, properties_package)
...
for c in Out_flow_reactor1.comp_dict:
    Out_flow_reactor1.comp_dict[c]['mole_flow'] = global_model.reactor_1.outflow[c]
...
#                                          domain=pyo.NonNegativeReals)
# reactor2_model = CstrSingleLiqPhase(198, 101325, 5.1, Out_flow_reactor1, reaction_set_1, properties_package)
...
#     Out_flow_reactor2.comp_dict[c]['mole_flow'] = global_model.reactor_2.outflow[c]
...
global_model.out_let_mwn_1 = pyo.Expression(expr=pyo.log10((spliter.split_Out_flow_list[
                                                                0].comp_dict[
                                                                'first_mom_live[1]'][
                                                                "mole_flow"] +
                                                            spliter.split_Out_flow_list[
                                                                ...
                                                                "mole_flow"]) / (
                                                                   ...
                                                                   spliter.split_Out_flow_list[
                                                                       ...
                                                                       'zeroth_mom_dead[1]'][
                                                                       "mole_flow"]) * 56))
global_model.out_let_mww_1 = pyo.Expression(expr=pyo.log10((spliter.split_Out_flow_list[
                                                                0].comp_dict[
                                                                'second_mom_live[1]'][
                                                                "mole_flow"] +
                                                            spliter.split_Out_flow_list[
                                                                ...
                                                                "mole_flow"]) / (
                                                                   ...
                                                                   spliter.split_Out_flow_list[
                                                                       ...
                                                                       'first_mom_dead[1]'][
                                                                       "mole_flow"]) * 56))
global_model.out_let_mwn_2 = pyo.Expression(expr=pyo.log10((spliter.split_Out_flow_list[
                                                                0].comp_dict[
                                                                'first_mom_live[2]'][
                                                                "mole_flow"] +
                                                            spliter.split_Out_flow_list[
                                                                ...
                                                                "mole_flow"]) / (
                                                                   ...
                                                                   spliter.split_Out_flow_list[
                                                                       ...
                                                                       'zeroth_mom_dead[2]'][
                                                                       "mole_flow"]) * 56))
global_model.out_let_mww_2 = pyo.Expression(expr=pyo.log10((spliter.split_Out_flow_list[
                                                                0].comp_dict[
                                                                'second_mom_live[2]'][
                                                                "mole_flow"] +
                                                            spliter.split_Out_flow_list[
                                                                ...
                                                                "mole_flow"]) / (
                                                                   ...
                                                                   spliter.split_Out_flow_list[
                                                                       ...
                                                                       'first_mom_dead[2]'][
                                                                       "mole_flow"]) * 56))
global_model.out_let_mwn_3 = pyo.Expression(expr=pyo.log10((spliter.split_Out_flow_list[
                                                                0].comp_dict[
                                                                'first_mom_live[3]'][
                                                                "mole_flow"] +
                                                            spliter.split_Out_flow_list[
                                                                ...
                                                                "mole_flow"]) / (
                                                                   ...
                                                                   spliter.split_Out_flow_list[
                                                                       ...
                                                                       'zeroth_mom_dead[3]'][
                                                                       "mole_flow"]) * 56))
global_model.out_let_mww_3 = pyo.Expression(expr=pyo.log10((spliter.split_Out_flow_list[
                                                                0].comp_dict[
                                                                'second_mom_live[3]'][
                                                                "mole_flow"] +
                                                            spliter.split_Out_flow_list[
...
global_model.M0 = pyo.Expression(expr=spliter.split_Out_flow_list[0].comp_dict['zeroth_mom_live[1]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['zeroth_mom_dead[1]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['zeroth_mom_live[2]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['zeroth_mom_dead[2]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['zeroth_mom_live[3]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['zeroth_mom_dead[3]']['mole_flow'])

global_model.M1 = pyo.Expression(expr=spliter.split_Out_flow_list[0].comp_dict['first_mom_live[1]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['first_mom_dead[1]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['first_mom_live[2]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['first_mom_dead[2]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['first_mom_live[3]']['mole_flow'] +
                                      spliter.split_Out_flow_list[0].comp_dict['first_mom_dead[3]']['mole_flow'])

global_model.out_let_pdi_1 = pyo.Expression(
    expr=global_model.out_let_mww_1 / global_model.out_let_mwn_1)
global_model.out_let_pdi_2 = pyo.Expression(
    expr=global_model.out_let_mww_2 / global_model.out_let_mwn_2)
global_model.out_let_pdi_3 = pyo.Expression(
    expr=global_model.out_let_mww_3 / global_model.out_let_mwn_3)
...
solver.solve(global_model, tee=True)
